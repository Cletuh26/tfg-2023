...
class RutinaDefectoSeeder extends Seeder
{
    ...
    {
        RutinaDefectoModel::create(['descripcion' => 'Este tipo de rutinas estan enfocadas a mantener un cuerpo enérgico y sano. La favorita de la gente.','tipo' => 'equilibrada', 'imagen' => 'images/rutinas_defecto/equilibrada.jpeg']);
