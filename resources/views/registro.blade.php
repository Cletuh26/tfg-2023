                        ...
                        <div class="card-body p-5 pt-2 pb-2 text-center">
                            ...
                            <div class="mb-md-4 mt-md-1 pb-1">
                                ...
                                <form action="{{ route('registroProcesado') }}" method="POST">
                                    ...
                                    <input type="text" id="dni" name="dni" class="form-control form-control-lg" minlength="9" maxlength="9" placeholder="Introduce tu DNI" value="{{ old('dni') }}" required title="Introduce 8 números y 1 letra (DNI)"/>
                                    @error('dni')
                                    ...
                                    <input type="text" id="nick" name="nick" placeholder="Introduce nombre de usuario" class="form-control form-control-lg" value="{{ old('nick') }}" required title="Introduce un nombre de usuario"/>
                                    @error('nick')
                                    <small style='color:#ff4040;'>{{ $message }}</small><br><br>
                                    @enderror

                                    <label class="form-label" for="password">Contraseña</label>
                                    <input type="password" id="password" name="password" placeholder="Introduce contraseña" class="form-control form-control-lg" required title="Introduce una contraseña"/>
                                    @error('password')
                                    <small style='color:#ff4040;'>{{ $message }}</small><br><br>
                                    @enderror
