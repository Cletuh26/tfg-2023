...
<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="{{ route('inicio') }}">
            <img src="{{ asset('assets/img/club-algar-blanco.png') }}" alt="Logo empresa" id="logoEmpresa">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ route('dietas.index') }}">Dietas</a>
                </li>
                @auth
                    <li class="nav-item">
                        <a class="nav-link px-lg-3 py-3 py-lg-4 text-dark" href="{{ route('perfil') }}">{{ ucfirst(Auth::user()->nick) }}</a>
                    </li>
                    {{-- <li class="nav-item">
